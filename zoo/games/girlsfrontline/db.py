...
def sync(src_repo: str = 'deepghs/girlsfrontline_voices_index', dst_repo: str = 'deepghs/girlsfrontline_voices_jp'):
    hf_fs = get_hf_fs()
    ...
    with TemporaryDirectory() as upload_dir:
        ...
        with open(os.path.join(upload_dir, 'README.md'), 'w') as f:
            ...
            print(f'# JP Voice-Text Dataset for Girls Front Line Waifus', file=f)
            print(f'', file=f)
            print(f'This is the JP voice-text dataset for girls front line playable characters. '
        ...
        upload_directory_as_directory(
            ...
            path_in_repo='.',
            message=f'Sync {plural_word(len(df_rows) - original_count, "new record")} for girlsfrontline jp voices'
        )
